    ...
    IModelFinalizingConvention
{
        ...
        IConventionContext<IConventionAnnotation> context)
    {
        ...
        if (entityType.FindPrimaryKey() is IConventionKey primaryKey)
        {
            ...
            IConventionEntityType rootType = entityType.GetRootType();
            bool isTPT = rootType.GetDerivedTypes().FirstOrDefault() is { } derivedType
            ...
            else
            {
                ...
                foreach (IConventionEntityType type in entityType.GetRootType().GetDerivedTypesInclusive())
                {
    ...
    public void ProcessModelFinalizing(IConventionModelBuilder modelBuilder, IConventionContext<IConventionModelBuilder> context)
    {
        foreach (IConventionEntityType entityType in modelBuilder.Metadata.GetEntityTypes())
        {
            foreach (IConventionProperty property in entityType.GetProperties())
            {
                ...
                string shortName = entityType.ShortName();
    ...
    private void RewriteColumnName(IConventionPropertyBuilder propertyBuilder)
    {
        ...
        IConventionTypeBase entityType = property.DeclaringType;
        ...
        string? baseColumnName = StoreObjectIdentifier.Create(property.DeclaringType, StoreObjectType.Table) is { } tableIdentifier
        ...
        foreach (StoreObjectType storeObjectType in _storeObjectTypes)
        {
            StoreObjectIdentifier? identifier = StoreObjectIdentifier.Create(entityType, storeObjectType);
