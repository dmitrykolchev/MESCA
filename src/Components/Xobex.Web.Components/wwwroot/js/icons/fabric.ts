...
export const FabricIcons = Object.freeze(fabricIcons);
export type FabricIconName = keyof typeof fabricIcons;

class FabricIcon extends IconBase {
    constructor() {
        super();
    }
    ...
    protected getGlyph(): string {
        ...
        return name ? FabricIcons[name as FabricIconName] : "";
    }

    protected getFontFamily(): string {
        return "FabricMDL2Icons";
    }
...
customElements.define("x-icon-fabric", FabricIcon);
